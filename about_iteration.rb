...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Another word for reduce. "Reduces" the array to something, the first argument is
    # the initial value of the accumulator/sum variable.
  end
  ...
  # Because the block automatically closes the file afterwards?
  #
