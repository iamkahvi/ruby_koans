...
class AboutClassMethods < Neo::Koan
  ...
  # I prefer the self.method syntax because it's more concise and simpler to me.
  # Are there times you might prefer one over the other?
  # If you were writing a bunch of class methods then the latter syntax would make sense.
